...
describe('sourceSanitizer', () => {
    ...
    it('Removes data-storybook-callbacks attribute', () => {
        const source = dedent`
        <twig:Component :prop="prop" :data-storybook-callbacks="click"/>
        `;
    ...
    it('Removes literal data-storybook-callbacks attribute', () => {
        const source = dedent`
        <twig:Component :prop="prop" data-storybook-callbacks="click"/>
        `;
