import { WebRenderer, ArgsStoryFn, Args, StrictArgs, DecoratorFunction, LoaderFunction, ComponentAnnotations, ProjectAnnotations, StoryContext as StoryContext$1, AnnotatedStoryFn, StoryAnnotations, RenderContext } from 'storybook/internal/types';
