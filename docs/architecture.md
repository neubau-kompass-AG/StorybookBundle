...
Use Webpack when an existing Storybook setup depends on Webpack loaders, plugins, aliases, or other Webpack-only behaviour. The Webpack package targets Storybook's Webpack 5 builder.
